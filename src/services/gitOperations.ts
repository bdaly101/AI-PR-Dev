...
export class GitOperationsService {
  ...
  async createPRFromPlan(options: CreatePROptions): Promise<GitOperationResult> {
    ...
    try {
      ...
      const prBody = this.generatePRBody(plan, triggeredBy, originalPR, committedFiles);
      ...
      // Step 7: Add labels
      try {
        await client.addLabels(owner, repo, newPR.number, ['ai-generated', 'automated']);
      } catch (labelError) {
  ...
  private generatePRBody(
    ...
    body += `This PR was automatically generated by AI Dev Agent.\n\n`;
    ...
    body += `*Please verify all changes carefully.*`;
